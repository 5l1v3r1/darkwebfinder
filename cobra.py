...
[+] TOR Powered :  TORCobra
[+] TOR Powered :  Cobra can download all files from TOR Website Easily
[+] Syntax 	:  python3 cobra.py --wait=2 --download-files https://address.onion

""")

__all__ = ['boss', 'download_files', 'download_file', 'run_cmd']
WANTED_EXT = '\.(pdf?|docx?|xlsx?|svg?|swf?|pptx?|o(d|t)[cgmpst]|csv|rtf|zip|rar|t?gz|xz|gz?)$'
BIN_EXT = re.compile(
